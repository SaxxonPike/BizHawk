namespace BizHawk.Emulation.Cores.Computers.Commodore64.MOS
{
	public sealed partial class Vic
	{
		...
		{
			return ReadRegister(unchecked((ushort) (addr & 0x3F)));
		}

		public void Poke(ushort addr, byte val)
		{
			WriteRegister(unchecked((ushort) (addr & 0x3F)), val);
		}
		...
		private byte ReadRegister(ushort addr)
		{
			switch (addr)
			{
				...
				case 0x0C:
				case 0x0E:
					return unchecked((byte)_sprites[addr >> 1].X);
				case 0x01:
				case 0x03:
				case 0x05:
				case 0x07:
				...
				case 0x0D:
				case 0x0F:
					return unchecked((byte) _sprites[addr >> 1].Y);
				case 0x10:
					return unchecked((byte)(((_sprite0.X >> 8) & 0x01) |
							 ((_sprite1.X >> 7) & 0x02) |
							 ((_sprite2.X >> 6) & 0x04) |
							 ((_sprite3.X >> 5) & 0x08) |
							 ((_sprite4.X >> 4) & 0x10) |
							 ...
							 ((_sprite7.X >> 1) & 0x80)));
				case 0x11:
					return unchecked((byte)((_yScroll & 0x7) |
							 ...
							 ((_rasterLine & 0x100) >> 1)));
				case 0x12:
					return unchecked((byte)_rasterLine);
				case 0x13:
					return unchecked((byte) _lightPenX);
				case 0x14:
					return unchecked((byte) _lightPenY);
				case 0x15:
					return unchecked((byte)((_sprite0.Enable ? 0x01 : 0x00) |
				...
				case 0x16:
					return unchecked((byte)(0xC0 | (_xScroll & 0x7) |
							  (_columnSelect ? 0x08 : 0x00) |
							  (_multicolorMode ? 0x10 : 0x00)));
				case 0x17:
					return unchecked((byte)((_sprite0.YExpand ? 0x01 : 0x00) |
				...
				case 0x18:
					return unchecked((byte)(0x01 | ((_pointerVm & 0x3C00) >> 6) |
							  ((_pointerCb & 0x7) << 1)));
				case 0x19:
					return unchecked((byte)(0x70 | (_intRaster ? 0x01 : 0x00) |
							  (_intSpriteDataCollision ? 0x02 : 0x00) |
							  (_intSpriteCollision ? 0x04 : 0x00) |
							  (_intLightPen ? 0x08 : 0x00) |
							  ((_irqBuffer & 1) << 7)));
				case 0x1A:
					return unchecked((byte)(0xF0 | (_enableIntRaster ? 0x01 : 0x00) |
							  (_enableIntSpriteDataCollision ? 0x02 : 0x00) |
							  (_enableIntSpriteCollision ? 0x04 : 0x00) |
							  (_enableIntLightPen ? 0x08 : 0x00)));
				case 0x1B:
					return unchecked((byte)((_sprite0.Priority ? 0x01 : 0x00) |
				...
				case 0x1C:
					return unchecked((byte)((_sprite0.Multicolor ? 0x01 : 0x00) |
				...
				case 0x1D:
					return unchecked((byte)((_sprite0.XExpand ? 0x01 : 0x00) |
				...
				case 0x1E:
					return unchecked((byte)((_sprite0.CollideSprite ? 0x01 : 0x00) |
				...
				case 0x1F:
					return unchecked((byte)((_sprite0.CollideData ? 0x01 : 0x00) |
				...
				case 0x20:
					return unchecked((byte) (0xF0 | _borderColor & 0x0F));
				case 0x21:
					return unchecked((byte) (0xF0 | _backgroundColor0 & 0x0F));
				case 0x22:
					return unchecked((byte) (0xF0 | _backgroundColor1 & 0x0F));
				case 0x23:
					return unchecked((byte) (0xF0 | _backgroundColor2 & 0x0F));
				case 0x24:
					return unchecked((byte) (0xF0 | _backgroundColor3 & 0x0F));
				case 0x25:
					return unchecked((byte) (0xF0 | _spriteMulticolor0 & 0x0F));
				case 0x26:
					return unchecked((byte) (0xF0 | _spriteMulticolor1 & 0x0F));
				case 0x27:
				case 0x28:
				case 0x29:
				case 0x2A:
				...
				case 0x2D:
				case 0x2E:
					return unchecked((byte)(0xF0 | _sprites[addr - 0x27].Color & 0xF));
				default:
					return 0xFF;
			}
		}
